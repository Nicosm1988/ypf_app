...
Activos incorporados el **2026-07-10** para representar los productos Microsoft en la documentación pública del portal. Los SVG se copiaron byte a byte desde los paquetes oficiales; no se incorporaron los ZIP ni los PDF de origen.
...
- Usar los íconos únicamente para representar los productos Microsoft correspondientes en diagramas, materiales de aprendizaje o documentación del portal.
